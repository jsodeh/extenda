        ...
        <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
            <div className="w-full max-w-xs animate-in fade-in slide-in-from-bottom-4 duration-700">
                ...
                <div className="bg-card backdrop-blur-xl rounded-2xl p-6 border border-border shadow-xl">
                    <p className="text-muted-foreground text-xs text-center mb-4 font-medium">Choose a sign-up method</p>
                    ...
                    <div className="space-y-2.5">
                        ...
                        <button
                            ...
                            className="w-full bg-secondary text-secondary-foreground py-2.5 px-4 rounded-xl text-sm font-semibold flex items-center justify-center gap-2.5 hover:bg-accent transition-all active:scale-95 border border-border"
                        >
