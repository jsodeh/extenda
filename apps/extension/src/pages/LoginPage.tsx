                ...
                <div className="bg-white/5 backdrop-blur-xl rounded-2xl p-5 border border-white/10 shadow-xl">
                    ...
                    <div className="space-y-2.5">
                        <button
                            ...
                            className="w-full bg-white text-gray-800 py-2.5 px-4 rounded-xl text-sm font-semibold flex items-center justify-center gap-2.5 hover:bg-gray-50 transition-all active:scale-95 shadow-lg"
                        >
                        ...
                        <button
                            ...
                            className="w-full bg-slate-700 text-white py-2.5 px-4 rounded-xl text-sm font-semibold flex items-center justify-center gap-2.5 hover:bg-slate-600 transition-all active:scale-95 border border-white/10"
                        >
